...
const FormEnviar = () => {
    const handleEnviar = () => {
        ...
        const mensagemInput = document.getElementById('mensagemInput') as HTMLTextAreaElement;
        const mensagemValue = mensagemInput ? mensagemInput.value : '';

        // Constrói a mensagem do WhatsApp
        const mensagemWhatsApp = encodeURIComponent(`Olá, meu nome é ${nomeValue}. ${mensagemValue}`);
